...
import HeroWeapons.MantaRaySet;
import Parts.*;
import WeaponSets.AccurateCannons;
import WeaponSets.ArtemisLaunchers;
import WeaponSets.BasicArtillery;
import WeaponSets.BasicCannons;
import WeaponSets.BasicLasers;
import WeaponSets.HeavyCannons;
import WeaponSets.HeavyLasers;
import WeaponSets.InfernoLaunchers;
...
public class Menu extends JFrame
{
	...
	public void initShips()
	{
		...
		fighters[0] = new Ship("Fighter", "Nerf Fighter", 700, 1, new PowerPlant(250,700,700,500,0,5,200,250,true), 
				...
				new LifeSupport(100,50,20,1,200),new Medbay(50,1),new Sensors(50,1,200,50,false,50),5,1,20);
		...
		cruisers[0] = new Ship("Hardened Cruiser", "Hardened 'Bernardo' Cruiser", 3500, 25, new PowerPlant(700,3000,3700,2600,1,35,1500,2000,true), 
				...
				new LifeSupport(400,250,100,5,800),new Medbay(800,12),new Sensors(200,1,300,100,false,200),40,5,120); 
		...
		cruisers[1] = new Ship("Fleet Cruiser", "Terrifying Fleet Cruiser", 3000, 10, new PowerPlant(500,3000,3500,2500,2,12,1000,1750,true), 
				...
				new LifeSupport(500,300,100,7,600),new Medbay(500,8),new Sensors(200,1,300,100,false,200),30,3,80);
		...
		cruisers[2] = new Ship("Millennium Cruiser", "Millenium 'All-In' Cruiser", 2000, 15, new PowerPlant(400,4000,5000,3500,2,15,1250,2000,false), 
				...
				new LifeSupport(500,200,150,8,500),new Medbay(400,6),new Sensors(200,1,300,100,false,200),35,3,80);
		...
		cruisers[3] = new Ship("Frontline Cruiser", "Firey Frontline Cruiser", 3000, 12, new PowerPlant(500,3500,4000,3000,2,15,1000,1750,true), 
				...
				new LifeSupport(400,300,150,6,700),new Medbay(600,10),new Sensors(200,1,300,100,false,200),40,5,100);
		...
		cruisers[4] = new Ship("Thunder Cruiser", "Rolling Thunder Cruiser", 3500, 30, new PowerPlant(500,3500,4000,3000,1,25,1000,1500,true),
				...
				new LifeSupport(400,200,100,5,600),new Medbay(500,8),new Sensors(200,1,300,100,false,200),30,3,80);
		...
		cruisers[5] = new Ship("Manta Cruiser", "Manta Ray Cruiser", 3500, 30, new PowerPlant(550,3750,4500,3250,2,15,1250,1750,true),
				...
				new LifeSupport(500,300,150,7,500),new Medbay(400,4),new Sensors(200,1,300,100,false,200),30,4,100);
		...
		cruisers[6] = new Ship("Alamo Cruiser", "Alamo Battle Cruiser", 2000, 10, new PowerPlant(500,3200,4000,3000,2,10,800,1200,true),
				...
				new Engine(400,250,0.95,1,10,1300,1600), new LifeSupport(300,200,100,2,400),new Medbay(300,2),new Sensors(200,1,300,100,false,200),30,2,80);
		...
		cruisers[7] = new Ship("Inferno Cruiser", "Inferno 'Crew-Killer' Cruiser", 2500, 10, new PowerPlant(450,2500,3500,2000,2,10,700,1000,true),
				...
				new Engine(400,300,0.9,1,8,1200,1600), new LifeSupport(350,200,100,3,300),new Medbay(300,2),new Sensors(200,1,300,100,false,200),35,2,100);
		...
		battleships[0] = new Ship("Lancer Class Battleship", "The Shining Lancer", 7000, 150, new PowerPlant(1000,6500,7500,6000,3,50,6000,8500,true),
				...
				new LifeSupport(1200,800,500,20,1700),new Medbay(1500,25),new Sensors(200,1,300,100,false,200),150,15,400);
		...
		battleships[1] = new Ship("Gaurdian Class Battleship", "The Fire Gaurdian", 10000, 150, new PowerPlant(1200,7500,9000,7500,3,60,5000,7000,true),
				...
				new LifeSupport(1500,900,500,25,1500), new Medbay(1400,20),new Sensors(200,1,300,100,false,200),200,20,400);
		
		
		//PLAYER 2.
		fighters2[0] = new Ship("Fighter", "Nerf Fighter", 700, 1, new PowerPlant(250,700,700,500,0,5,200,250,true), 
				new Weapons(100,0,new WeaponSet[] {new AccurateCannons(5)},200), new Shields(100,100,1,3,100,200,true), new Engine(150,100,0.9,1,2,100,200),
				new LifeSupport(100,50,20,1,200),new Medbay(50,1),new Sensors(200,1,300,100,false,200),5,1,20);
	...
	private void initGUI()
	{
		...
		scrapSlider = new JSlider(0,3000,1800);
		scrapSlider.setMajorTickSpacing(1000);
		scrapSlider.setMinorTickSpacing(200);
